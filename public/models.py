...
class District(models.Model):
    ...
    district_name = models.CharField('name district',max_length=1, choices=DISTRICT_NAME)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    user_img_placeholder = models.ImageField(upload_to='users', blank=True, null=True)
    ...
    date_unsubscribe = models.DateTimeField('Date unsubscribe', blank=True, null=True)
...
class PickupPoint(models.Model):
    ...
    recovery_type = models.CharField('recovery type', choices=RECOVERY_TYPE, max_length=64)
...
class Category(models.Model): 
    ...
    category_name = models.CharField('category name',max_length=1,choices=CATEGORY)
...
class SubCategory(models.Model):
    ...
    sub_category_name = models.CharField('Sub-category name',max_length=1,choices=SUB_CATEGORY)
...
class Advert(models.Model): 
    ...
    advert_state = models.CharField('Advert state',max_length=1,choices=ADVERT_STATE)
    situation = models.CharField('situation',max_length=1,choices=SITUATION)
    price = models.FloatField(blank=True, null=True)
    type_place = models.CharField('type place ',max_length=1,choices=TYPE_PLACE)
    ...
    advert_img_placeholder = models.ImageField(upload_to='adverts', blank=True, null=True)
    object_state = models.CharField('stateObject',max_length=1,choices=OBJECT_STATE)
...
class Recovery(models.Model):
    ...
    recovery_date = models.DateTimeField('recovery date ')
...
class Like(models.Model):
    ...
    datetime = models.DateTimeField('When', auto_now_add=True)
...
class CenterOfInterest(models.Model):
    ...
    name_center_of_interest = models.CharField('name center of interest', max_length=1, choices=CENTERS_OF_INTEREST, blank=True, null=True)
...
class InterestFor(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    center_of_interest = models.ForeignKey(CenterOfInterest, on_delete=models.CASCADE)
